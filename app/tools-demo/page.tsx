  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="h-full flex flex-col">
        {/* Modern Header */}
        <header className="h-16 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800/50 flex items-center justify-between px-6 z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-bold gradient-text">Tools Demo</h1>
              <p className="text-xs text-slate-500">Interactive Canvas Tools</p>
            </div>
          </div>
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          {/* Floating Help Panel */}
          <div className="absolute bottom-6 left-6 bg-slate-900/80 backdrop-blur-xl rounded-xl border border-slate-800/50 p-4 shadow-2xl max-w-xs">
            ...
            <ul className="space-y-1 text-xs text-slate-400">
              <li>• Press <kbd className="px-1.5 py-0.5 bg-slate-800 rounded text-slate-300">V</kbd> for Select Tool</li>
              <li>• Press <kbd className="px-1.5 py-0.5 bg-slate-800 rounded text-slate-300">T</kbd> for Text Tool</li>
              <li>• Press <kbd className="px-1.5 py-0.5 bg-slate-800 rounded text-slate-300">Space</kbd> to pan canvas</li>
