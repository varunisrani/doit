                ...
                {properties.map((property) => {
                  ...
                  return (
                    <div
                      key={property}
                      className={`
                        px-4 py-3 border-b border-gray-800/50 transition-colors
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          {hasKeyframe && (
                            <div className="w-2 h-2 rotate-45 bg-purple-500" title="Has keyframe" />
                          )}
                        </div>
                        <button
                          onClick={(e) => {
                      ...
                      <div className="text-xs text-gray-400">
                        Current: {formatValue(currentValue, property)}
                      </div>
                    </div>
                  );
                })}
          ...
          <div className="p-4 bg-gray-800/30 border-t border-gray-700">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className="px-3 py-2 bg-gray-800 rounded text-sm text-white">
                  {propertyConfig[selectedKeyframe.property].label}
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-gray-800 border border-gray-700
                           rounded text-sm text-white focus:outline-none
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1">
                  Value {propertyConfig[selectedKeyframe.property].unit}
                </label>
                <input
                  type="number"
  ...
  return (
    <div className="bg-gray-800 rounded p-2">
      <svg viewBox="0 0 100 100" className="w-full h-24">
        ...
        <line x1="0" y1="100" x2="100" y2="0" stroke="#4b5563" strokeWidth="0.5" strokeDasharray="2,2" />

        {/* Easing curve */}
        <path d={pathD} fill="none" stroke="#8b5cf6" strokeWidth="2" />

        {/* Start and end points */}
        <circle cx="0" cy="100" r="2" fill="#8b5cf6" />
        <circle cx="100" cy="0" r="2" fill="#8b5cf6" />
      </svg>
    </div>
  );
};
